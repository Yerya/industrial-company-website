const industries = [
  {
    title: "Пищевая промышленность и переработка",
    description: "Молокозаводы, мясокомбинаты, пивзаводы, заводы безалкогольных напитков, консервные заводы, линии переработки пищевых продуктов",
