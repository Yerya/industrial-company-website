          ...
          <div>
            ...
            <div className="space-y-5 text-muted-foreground text-base md:text-lg leading-relaxed">
              <p>
                ...
                на поставке промышленного оборудования, комплектующих и комплексных инженерных решений.
              </p>
              <p>
                Мы работаем с ведущими европейскими производителями и обеспечиваем полный цикл —
                от подбора и поставки оборудования до монтажа, пусконаладки и сервисного обслуживания.
              </p>
            </div>
          </div>
